...
KEY = "10days/olfactory_challenge"

dag_params = {
    "synapse_conn_id": Param("SYNAPSE_ORCA_SERVICE_ACCOUNT_CONN", type="string"),
    "aws_conn_id": Param("AWS_TOWER_PROD_S3_CONN", type="string"),
    "revision": Param("TODO:TBD", type="string"),
    "challenge_profile": Param("TODO:TBD", type="string"),
    "tower_conn_id": Param("OLFACTORY_CHALLENGE_PROJECT_TOWER_CONN", type="string"),
    "tower_view_id": Param("TODO:TBD", type="string"),
...
@dag(**dag_config)
def olfactory_challenge_submission_dag():
    @task
    ...
    @task()
    def launch_workflow(manifest_path: str, **context):
        hook = NextflowTowerHook(context["params"]["tower_conn_id"])
        run_uuid = context["params"]["uuid"]
        info = LaunchInfo(
            run_name=f"olfactory-challenge-evaluation-{run_uuid}",
    ...
    run_id = launch_workflow(manifest_path=manifest_path)
...
olfactory_challenge_submission_dag()
