"""https://sagebionetworks.jira.com/browse/WORKFLOWS-553
...
def generate_datasets() -> list[Dataset]:
    ...
    return [
        Dataset(
            id="syn55224474",
            samplesheet="syn23664726_Batch1_WGS_SampleSheet.csv",
            staging_key="samplesheets/Sarek_Process/WORKFLOWS-553/",
            bucket_name="ntap-add5-project-tower-bucket",
            synapse_id_for_output="syn54083848",
            run_number=1,
            output_number=1,
        )
    ]
